...
@section('title', 'Add Task - EstateFlow')
@section('page-title', 'Add Task')
@section('page-subtitle', 'Create a new project task')
    ...
    <div class="bg-white rounded-xl shadow-sm p-6">
        <form method="POST" action="{{ route('tasks.store') }}">
            ...
            <div class="mt-6 flex gap-3">
                <button type="submit" class="bg-indigo-600 text-white px-6 py-2 rounded-lg text-sm hover:bg-indigo-700 transition font-medium">Save Task</button>
                <a href="{{ route('tasks.index') }}" class="bg-gray-100 text-gray-600 px-6 py-2 rounded-lg text-sm hover:bg-gray-200 transition">Cancel</a>
            </div>
        </form>
    </div>
</div>
