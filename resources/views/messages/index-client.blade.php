...
<head>
    ...
    <title>Messages — EstateFlow</title>
...
<div class="max-w-3xl mx-auto px-6 py-8">
    ...
    <p class="text-gray-500 text-sm mb-8">Your conversations</p>
    ...
    @if($search)
        <p class="text-sm text-gray-500 mb-4">
            Results for <span class="font-medium text-gray-800">"{{ $search }}"</span> — {{ $conversations->count() }} found
        </p>
    @endif
    ...
    <div class="bg-white rounded-xl shadow-sm overflow-hidden">
            ...
            <a href="{{ route('messages.show', $other) }}"
                ...
                <div class="relative flex-shrink-0">
                    <div class="w-11 h-11 rounded-full flex items-center justify-center font-semibold text-white
                        {{ $other->role === 'agent' ? 'bg-blue-500' : 'bg-indigo-500' }}">
                ...
                <div class="flex-1 min-w-0">
                    <div class="flex items-center justify-between">
                        <p class="font-medium text-gray-800">{{ $other->name }}</p>
        ...
        @empty
            <div class="px-6 py-16 text-center text-gray-400">
                <i class="fas fa-comments text-4xl mb-3 block text-gray-200"></i>
                <p>No messages yet.</p>
