...
<head>
    ...
    <title>My Payments — EstateFlow</title>
...
<div class="max-w-7xl mx-auto px-6 py-8">
    ...
    <h1 class="text-2xl font-bold text-gray-900 mb-1">My Payments</h1>
    <p class="text-gray-500 text-sm mb-8">Your complete payment history</p>

    @if(session('success'))
        <div class="mb-6 bg-green-50 border border-green-200 text-green-700 text-sm px-5 py-4 rounded-xl">
