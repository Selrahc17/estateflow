...
@else
    {{-- Non-client: render inside the sidebar layout manually --}}
    ...
    <div class="bg-white rounded-xl shadow-sm p-6">
        <div class="flex items-center gap-4 mb-6 pb-6 border-b border-gray-100">
            ...
            <div>
                ...
                <span class="text-xs px-2 py-0.5 rounded-full font-medium mt-1 inline-block
                    ...
                    {{ $user->role === 'finance' ? 'bg-yellow-100 text-yellow-700': '' }}">
                    {{ ucfirst($user->role) }}
                </span>
            </div>
        </div>
        ...
        <form method="POST" action="{{ route('profile.update') }}" enctype="multipart/form-data">
            ...
            <div class="mt-6 flex gap-3">
                ...
                <a href="{{ auth()->user()->isClient() ? route('home') : route('dashboard') }}"
...
@else
    ...
    {{-- Render properly inside sidebar layout --}}
    <script>
        // Move profile-content out of the hidden div into the page body
