...
@section('title', 'Add Milestone - EstateFlow')
@section('page-title', 'Add Milestone')
@section('page-subtitle', 'Create a new project milestone')
    ...
    <div class="bg-white rounded-xl shadow-sm p-6">
        <form method="POST" action="{{ route('milestones.store') }}">
            ...
            <div class="mt-6 flex gap-3">
                <button type="submit" class="bg-indigo-600 text-white px-6 py-2 rounded-lg text-sm hover:bg-indigo-700 transition font-medium">Save Milestone</button>
                <a href="{{ route('milestones.index') }}" class="bg-gray-100 text-gray-600 px-6 py-2 rounded-lg text-sm hover:bg-gray-200 transition">Cancel</a>
            </div>
        </form>
    </div>
</div>
